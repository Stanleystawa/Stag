...
module.exports.run = async function({ api, event, args }) {
		if (!args[0]) {
				api.sendMessage("Please provide a question or statement after 'ai'. For example: hercai What is the capital of France?Create by Stanley stawa", event.threadID);
				return;
		}
